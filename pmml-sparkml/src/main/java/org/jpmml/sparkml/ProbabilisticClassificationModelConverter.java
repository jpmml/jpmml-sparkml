...
abstract
public class ProbabilisticClassificationModelConverter<T extends /*Probabilistic*/ClassificationModel<Vector, T> & HasProbabilityCol> extends ClassificationModelConverter<T> {
