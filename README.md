...
The current version is **1.3.0** (17 July, 2017).
...
| 1.1.0 | 2.0.X | 4.2 |
| 1.1.1 through 1.1.12 | 2.0.X | 4.3 |
| 1.2.0 through 1.2.4 | 2.1.X | 4.3 |
| 1.3.0 | 2.2.X | 4.3 |
...
```
spark-submit --master local --class org.jpmml.sparkml.Main target/converter-executable-1.3-SNAPSHOT.jar --ser-schema-input src/test/resources/ser/Iris.ser --ser-pipeline-input src/test/resources/ser/DecisionTreeIris.ser --pmml-output DecisionTreeIris.pmml
```
