...
* `target/jpmml-sparkml-2.1-SNAPSHOT.jar` - Library JAR file.
* `target/jpmml-sparkml-executable-2.1-SNAPSHOT.jar` - Example application JAR file.
...
```
spark-submit --master local --class org.jpmml.sparkml.Main target/jpmml-sparkml-executable-2.1-SNAPSHOT.jar --schema-input src/test/resources/schema/Iris.json --pipeline-input src/test/resources/pipeline/DecisionTreeIris.zip --pmml-output DecisionTreeIris.pmml
```

Getting help:
```
spark-submit --master local --class org.jpmml.sparkml.Main target/jpmml-sparkml-executable-2.1-SNAPSHOT.jar --help
```
