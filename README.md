...
The current version is **1.1.14** (13 August, 2017).
...
| 1.1.0 | 2.0.X | 4.2 |
| 1.1.1 through 1.1.14 | 2.0.X | 4.3 |
...
```
spark-submit --master local --properties-file src/etc/converter.properties --class org.jpmml.sparkml.Main target/converter-executable-1.1-SNAPSHOT.jar --schema-input src/test/resources/schema/Iris.json --pipeline-input src/test/resources/pipeline/DecisionTreeIris.zip --pmml-output DecisionTreeIris.pmml
```
