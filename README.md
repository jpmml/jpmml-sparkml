...
The current version is **1.3.7** (5 June, 2018).
...
| 1.1.0 | 2.0.X | 4.2 |
| 1.1.1 through 1.1.19 | 2.0.X | 4.3 |
| 1.2.0 through 1.2.11 | 2.1.X | 4.3 |
| 1.3.0 through 1.3.7 | 2.2.X | 4.3 |
...
* `target/jpmml-sparkml-executable-1.3-SNAPSHOT.jar` - Example application JAR file.
...
```
spark-submit --master local --class org.jpmml.sparkml.Main target/jpmml-sparkml-executable-1.3-SNAPSHOT.jar --schema-input src/test/resources/schema/Iris.json --pipeline-input src/test/resources/pipeline/DecisionTreeIris.zip --pmml-output DecisionTreeIris.pmml
```

Getting help:
```
spark-submit --master local --class org.jpmml.sparkml.Main target/jpmml-sparkml-executable-1.3-SNAPSHOT.jar --help
```
