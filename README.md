...
<details>
  ...
  Examples: [main.py](https://github.com/jpmml/jpmml-sparkml/blob/2.1.X/pmml-sparkml/src/test/resources/main.py)
...
<details>
  ...
  Examples: [LightGBMAuditNA.scala](https://github.com/jpmml/jpmml-sparkml/blob/2.1.X/pmml-sparkml-lightgbm/src/test/resources/LightGBMAuditNA.scala), [LightGBMAutoNA.scaka](https://github.com/jpmml/jpmml-sparkml/blob/2.1.X/pmml-sparkml-lightgbm/src/test/resources/LightGBMAutoNA.scala), etc.
...
<details>
  ...
  Examples: [XGBoostAuditNA.scala](https://github.com/jpmml/jpmml-sparkml/blob/2.1.X/pmml-sparkml-xgboost/src/test/resources/XGBoostAuditNA.scala), [XGBoostAutoNA.scala](https://github.com/jpmml/jpmml-sparkml/blob/2.1.X/pmml-sparkml-xgboost/src/test/resources/XGBoostAutoNA.scala), etc.
...
The current version is **2.1.6** (10 February, 2025).
...
* `pmml-sparkml/target/pmml-sparkml-2.1-SNAPSHOT.jar` - Library JAR file.
* `pmml-sparkml-exampletarget/pmml-sparkml-example-executable-2.1-SNAPSHOT.jar` - Example application JAR file.
