...
The current version is **3.1.7** (29 November, 2025).
...
* `pmml-sparkml/target/pmml-sparkml-3.1-SNAPSHOT.jar` - Library JAR file.
* `pmml-sparkml-exampletarget/pmml-sparkml-example-executable-3.1-SNAPSHOT.jar` - Example application JAR file.
