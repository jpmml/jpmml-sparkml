...
val regressor = new XGBoostRegressor(Map("objective" -> "reg:squarederror", "num_round" -> 101, "num_workers" -> 1)).setLabelCol("mpg").setFeaturesCol(sparse2dense.getOutputCol)
